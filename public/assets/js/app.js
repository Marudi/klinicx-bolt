...
(function () {
  ...
  function setLanguage(lang) {
    document.getElementsByClassName("header-lang-img").forEach(function (el) {
      if (el) {
        switch (lang) {
          case "en":
            el.src = "public/assets/images/flags/us.jpg";
            break;
          case "sp":
            el.src = "public/assets/images/flags/spain.jpg";
            break;
          case "gr":
            el.src = "public/assets/images/flags/germany.jpg";
            break;
          case "it":
            el.src = "public/assets/images/flags/italy.jpg";
            break;
          case "ru":
            el.src = "public/assets/images/flags/russia.jpg";
            break;
          default:
            el.src = "public/assets/images/flags/us.jpg";
            break;
  ...
  function getLanguage() {
    ...
    request.open("GET", "/public/assets/lang/" + language + ".json");
      ...
      (function (index) {
        verticalButton[index] &&
          verticalButton[index].addEventListener("click", function (event) {
            ...
            console.log(window.innerWidth) ;console.log(currentSIdebarSize); console.log( document.body.getAttribute("data-sidebar-size"));
  ...
  function changeDirection(id) {
    if (
      ...
      document
        ...
        .setAttribute("href", "public/assets/css/bootstrap.min.css");
      document
        .getElementById("app-style")
        .setAttribute("href", "public/assets/css/app.min.css");
      sessionStorage.setItem("is_visited", "layout-direction-ltr");
    } else if (
      ...
      document
        .getElementById("bootstrap-style")
        .setAttribute("href", "public/assets/css/bootstrap-rtl.min.css");
      document
        .getElementById("app-style")
        .setAttribute("href", "public/assets/css/app-rtl.min.css");
  ...
  function layoutSetting() {
      ...
      lightDarkBtn.forEach(function (item) {
        item.addEventListener("click", function (event) {
          ...
          if (
            ...
            $.ajax({
              url: "home/navBarColor?color=" + 'light',
              method: "GET",
              data: "",
              dataType: "json",
              success: function (response) {
                if (response){
                  toastr.success("Color change to light !!!")
                }else{
                  toastr.wanring("Color cannot be changed!!!!")
                }
              }
            });
            ...
            $.ajax({
              url: "home/navBarColor?color=" + 'dark',
              method: "GET",
              data: "",
              dataType: "json",
              success: function (response) {
                if (response){
                  toastr.success("Color change to dark !!!")
                }else{
                  toastr.wanring("Color cannot be changed!!!!")
                }
              }
    ...
    body.hasAttribute("data-layout-mode") &&
      body.getAttribute("data-layout-mode") == "dark" ||   color_topbar=='dark' ?
      updateRadio("layout-mode-dark") :
      updateRadio("layout-mode-light");
  ...
  //  var color_th= $('input[name="layout-mode"]:checked').val();
      ...
      .forEach(function (input) {
        input.addEventListener("change", function (e) {
          ...
          if (e && e.target && e.target.value) {
            if (e.target.value == "light" && (color_topbar=='light'||color_topbar==null)) {
              document.body.setAttribute("data-layout-mode", "light");
              document.body.setAttribute("data-topbar", "light");
              document.body.setAttribute("data-sidebar", "dark");
