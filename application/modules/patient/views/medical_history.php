                ...
                <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"> <?php echo lang('history'); ?></h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('home'); ?></a></li>
                                        <li class="breadcrumb-item"> <?php echo lang('patient'); ?></li>
                                        <li class="breadcrumb-item active"> <?php echo lang('history'); ?></li>
...
<div class="row">
        <section class="col-md-3 col-sm-12 card">
                <div class="card-header table_header">
                                        <h4 class="card-title mb-0 col-lg-8"> <?php echo lang('patient'); ?> <?php echo lang('info'); ?></h4> 
                    ...
                    <section class="">
                        ...
                        <div class="user-heading round col-md-6">
                                <?php if (!empty($patient->img_url)) { ?>
                                    <a href="#">
                                        <img class="card-img-top img-fluid rounded-circle avatar-xl" src="<?php echo $patient->img_url; ?>" alt="">
                                    </a>
                                <?php } ?>
                           
                            </div>
                            <div class="col-md-6" style="padding-top: 20px;">
                                    <h4 class=""> <?php echo $patient->name; ?> </h4>
                                    <p class="card-text"> <?php echo $patient->email; ?> </p>
                                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                        <button type="button" class="btn btn-soft-info btn-xs btn_width editPatient" title="<?php echo lang('edit'); ?>" data-bs-toggle="modal"
                                                     data-id="<?php echo $patient->id; ?>"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></button>
                                    <?php } ?>
                            </div>
                        
                        </div>
                            </li>
                            <li class="list-group-item"> <?php echo lang('patient_id'); ?><span class="label pull-right r-activity float-end"><small><?php echo $patient->id_new; ?></small></span></li>
                            <li class="list-group-item">  <?php echo lang('gender'); ?> <span class="label pull-right r-activity float-end"><?php echo $patient->sex; ?></span></li>
                            <li class="list-group-item">  <?php echo lang('birth_date'); ?><span class="label pull-right r-activity float-end"><?php echo $patient->birthdate; ?></span></li>
                            <li class="list-group-item">  <?php echo lang('phone'); ?><span class="label pull-right r-activity float-end"><?php echo $patient->phone; ?></span></li>
                            <li class="list-group-item">  <?php echo lang('email'); ?><span class="label pull-right r-activity float-end"><?php echo $patient->email; ?></span></li>
                            <li class="list-group-item">  <?php echo lang('address'); ?><span class="label pull-right r-activity float-end"><?php echo $patient->address; ?></span></li>
                        </ul>
        ...
        <section class="col-md-9">
            <div class="card">
                        <div class="card-header">
                            <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                <div class="row">
                                        <h4 class="card-title mb-0 col-lg-9">  <?php echo lang('history'); ?> | <?php echo $patient->name; ?> </h4> 
                               
                                        <div class="col-lg-3">
                                            <select class="pos_select" id="pos_select" name="patient_id" value='' style="font-weight:300 !important;">
                                                <option value="<?php echo $patient->id; ?>" selected><?php echo lang('id') . ':' . $patient->id; ?></option>

                                            </select>
                                        </div>
                        </div>
                                    <?php }else{ ?>
                                        <h4 class="card-title mb-0 col-lg-12">  <?php echo lang('history'); ?> | <?php echo $patient->name; ?> </h4> 
                                        <?php } ?>
                        </div>
            ...
            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link   <?php if ($redirect_tab == '') {
                                        echo 'active';
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link   <?php if ($redirect_tab == 'vital') {
                                        echo 'active';
                                    } ?>" data-bs-toggle="tab" href="#vital" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('vital_signs'); ?></span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link   <?php if ($redirect_tab == 'case') {
                                        echo 'active';
                                    } ?>" data-bs-toggle="tab" href="#home" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('case_history'); ?></span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#lab" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('lab'); ?></span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link  <?php if ($redirect_tab == 'files') {
                                        echo 'active';
                                    } ?>" data-bs-toggle="tab" href="#profile" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('documents'); ?></span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#contact" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('bed'); ?></span> 
                                                </a>
                                            </li>
                                            <?php
                        if (!$this->ion_auth->in_group(array('Patient'))) {
                            if ($settings->show_odontogram_in_history == 'yes') { ?>
                                <li class="nav-item">
                                                <a class="nav-link   <?php if ($redirect_tab == 'odontogram') {
                                        echo 'active';
                                    } ?>" data-bs-toggle="tab" href="#odontogram" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('odontogram'); ?></span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#timeline" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                                    <span class="d-none d-sm-block"><?php echo lang('timeline'); ?></span> 
                                                </a>
                                            </li>
<?php }
                        } ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu folder_div" role="menu">
                                                            <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                                ...
                                                                <div class="dropdown-divider"></div><li><a class="dropdown-item" href="patient/deleteFolder?id=<?php echo $folder->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><?php echo lang('delete'); ?></a></li>
                                                                <div class="dropdown-divider"></div><li><a class="dropdown-item uploadbutton" data-toggle="modal" data-id="<?php echo $folder->id; ?>"> <?php echo lang('upload_file'); ?> </a></li>
                                                            <?php } ?>
                                                            <div class="dropdown-divider"></div><li><a class="dropdown-item" href="patient/medicalHistoryByFolder?id=<?php echo $folder->id; ?>"><?php echo lang('view_files'); ?></a></li>
                                                        </ul>
                                                    </div>
